                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="birthday" class="form-control" id="birthday"
                                            value="{{ isset($student) ? $student->birthday : '' }}">
                                    </div>
                                    <div class="form-group">
                                        <label for="publisher">Giới tính (*)</label>
                                        <div class="row">
                                            <div class="col-sm-1">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="gender"
                                                        value="1"
                                                        {{ isset($student) && $student->gender == 1 ? 'checked' : '' }}>
                                            ...
                                            <div class="col-sm-1">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="gender"
                                                        value="2"
                                                        {{ isset($student) && $student->gender == 2 ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="address" class="form-control" id="address"
                                            placeholder="Nhập dịa chỉ" value="{{ $student->address }}">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select name="grade_level" id="grade_level" class="form-control">
                                            ...
                                            @for ($i = 1; $i <= 12; $i++)
                                                <option
                                                    {{ isset($student) && $student->grade_level == $i ? 'selected' : '' }}
                                                    value="{{ $i }}">Khối {{ $i }}</option>
                                            @endfor
                                            <option {{ isset($student) && $student->grade_level == 13 ? 'selected' : '' }}
                                                value="13">Khác</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="parent_guardian_name" class="form-control"
                                            ...
                                            value="{{ isset($student) ? $student->parent_guardian_name : '' }}">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select name="id_school" id="id_school" class="form-control select2bs4">
                                            ...
                                            @foreach ($schools as $school)
                                                <option value="{{ $school->id }}"
                                                    {{ isset($student) && $school->id == $student->id_school ? 'selected' : '' }}>
                                                    {{ $school->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
